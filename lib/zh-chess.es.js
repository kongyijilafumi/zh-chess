 ...
 * 坐标 -> 棋盘位表索引，越界返回 -1
 */
var posIdx = function (x, y) { return (x < 0 || x > 8 || y < 0 || y > 9) ? -1 : x + y * 9; };
    ...
    Object.defineProperty(ZhChess.prototype, "checkGeneralInTrouble", {
        ...
        value: function (side, pos, cp, pl, board) {
            ...
            try {
                ...
                var isAttackLine = function (pc) { return (pc.constructor === RookPiece || pc.constructor === GeneralPiece) && pc.side === enemySide; };
        ...
        value: function (enemySide, pl, board) {
            ...
            return pl.filter(function (i) { return i.side === enemySide; }).some(function (item) {
                ...
                return mps.some(function (p) {
                    var isDis = b[posIdx(p.disPoint.x, p.disPoint.y)];
                    if (isDis) {
                        return false;
                    }
