...
var HorsePiece = /** @class */ (function (_super) {
    ...
    Object.defineProperty(HorsePiece.prototype, "filterMovePoints", {
        ...
        writable: true,
        value: function (list, pl) {
            return _super.prototype.filterMovePoints.call(this, list, pl).filter(function (item) { return !Boolean(findPiece(pl, item.disPoint)); });
        }
    });
    /**
     * 根据象棋自己的移动规律以及棋子列表的位置得出是否可以移动到指定的坐标上
...
var ZhChess = /** @class */ (function () {
    ...
    */
    ...
    Object.defineProperty(ZhChess.prototype, "moveStart", {
        ...
        value: function (mp, checkPoint, drawList, side) {
            ...
            this.moveEvents.forEach(function (f) { return f(mp, checkPoint, isOver || enemyhasTrouble); });
            if (isOver) {
    ...
    Object.defineProperty(ZhChess.prototype, "moveStartAsync", {
        ...
        value: function (mp, checkPoint, drawList, side) {
            ...
            return this.movePeiceToPointAsync(p, drawList).then(function () {
                ...
                _this.moveEvents.forEach(function (f) { return f(mp, checkPoint, isOver || enemyhasTrouble); });
                if (isOver) {
    ...
    */
    ...
    Object.defineProperty(ZhChess.prototype, "currentDeadPieceList", {
        /**
         * 获取当前被吃掉的棋子列表
         */
        get: function () {
            return this.deadPieceList.map(function (item) {
                return chessOfPeiceMap[item.name](__assign({}, item));
            });
        },
        enumerable: false,
...
export { CannonPiece, ElephantPiece, GeneralPiece, HorsePiece, KnightPiece, MovePoint, Piece, Point, RookPiece, SoldierPiece, chessOfPeiceMap, ZhChess as default, peiceSideMap };
