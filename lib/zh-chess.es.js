...
var Game = /** @class */ (function () {
    ...
    Object.defineProperty(Game.prototype, "drawSinglePeice", {
        ...
        value: function (piece, replaceXY) {
            var _this = this;
            var _a = this, startX = _a.startX, startY = _a.startY, gridWidth = _a.gridWidth, gridHeight = _a.gridHeight;
     ...
     */
    Object.defineProperty(Game.prototype, "movePeiec", {
        enumerable: false,
        configurable: true,
        writable: true,
    ...
    Object.defineProperty(Game.prototype, "moveStart", {
        ...
        value: function (mp, p, drawList, side, isEat) {
            ...
            this.movePeiec(p, drawList).then(function () {
    ...
    Object.defineProperty(Game.prototype, "setGameState", {
        enumerable: false,
        configurable: true,
        writable: true,
    ...
    Object.defineProperty(Game.prototype, "deletePeice", {
        enumerable: false,
        configurable: true,
        writable: true,
        value: function () {
            var _this = this;
            if (this.choosePiece) {
                this.livePieceList = this.livePieceList.filter(function (i) { return i !== _this.choosePiece; });
                this.choosePiece = null;
                this.redraw();
            }
            else {
        ...
        value: function (e, fn) {
            if (typeof fn === "function") {
                if (e === "log") {
                    ...
                    this.moveEvents = this.logEvents.filter(function (f) { return f !== fn; });
                }
                else if (e === "moveFail") {
                    this.moveFailEvents = this.logEvents.filter(function (f) { return f !== fn; });
                }
                else if (e === "over") {
                    this.overEvents = this.logEvents.filter(function (f) { return f !== fn; });
                }
            }
            else {
                throw new Error("监听函数值应该为 function 类型");
...
export { CannonPiece, ElephantPiece, GeneralPiece, HorsePiece, KnightPiece, MovePoint, Piece, Point, RookPiece, SoldierPiece, chessOfPeiceMap, Game as default, peiceSideMap };
