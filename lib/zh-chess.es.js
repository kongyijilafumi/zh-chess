...
// 前兵进一
var parse_reg_1 = new RegExp("(".concat(strPos.concat(numMergePos).join("|"), ")(").concat(PieceNames.join("|"), ")(").concat(moveStyles.join("|"), ")(").concat(numMergePosStr, ")$"));
// 车9进1
var parse_reg_2 = new RegExp("(".concat(PieceNames.join("|"), ")(").concat(numMergePosStr, ")(").concat(moveStyles.join("|"), ")(").concat(numMergePosStr, ")$"));
// 前6进1
var parse_reg_3 = new RegExp("(".concat(strPos.join("|"), ")(").concat(numMergePosStr, ")(").concat(moveStyles.join("|"), ")(").concat(numMergePosStr, ")$"));
    ...
    Object.defineProperty(Game.prototype, "eatPeice", {
        ...
        value: function (p) {
            if (this.choosePiece) {
                ...
                var hasTrouble = this.checkGeneralInTrouble(side, this.choosePiece, { eat: p }, this.livePieceList);
                if (hasTrouble) {
    ...
    Object.defineProperty(Game.prototype, "move", {
        ...
        value: function (clickPoint) {
            ...
            if (!choosePiece) {
                ...
                if (moveFlag_1.flag) {
                    var hasTrouble = this.checkGeneralInTrouble(this.currentSide, this.choosePiece, { move: clickPoint }, this.livePieceList);
                    if (hasTrouble) {
...
export { MovePoint, Point, Game as default, peiceSideMap };
