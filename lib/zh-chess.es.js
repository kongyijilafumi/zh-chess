...
function gen_PEN_Str(pl, side) {
    ...
    PENList = PENList.map(function (item) {
        item = item.sort(function (a, b) { return b.x - a.x; });
        return item;
    });
    var str = '';
    for (var y = 0; y < PENList.length; y++) {
        ...
        for (var j = 0; j < len; j++, x--) {
            ...
            var step = (j > 0 ? (peiceList[j - 1].x - 1) : x) - (current.x);
            if (step > 0) {
                str += String(step);
            }
...
var ZhChess = /** @class */ (function () {
    function ZhChess(_a) {
        var ctx = _a.ctx, _b = _a.gameWidth, gameWidth = _b === void 0 ? 800 : _b, _c = _a.gameHeight, gameHeight = _c === void 0 ? 800 : _c, _d = _a.gamePadding, gamePadding = _d === void 0 ? 20 : _d, _e = _a.scaleRatio, scaleRatio = _e === void 0 ? 1 : _e, _f = _a.moveSpeed, moveSpeed = _f === void 0 ? 8 : _f, _g = _a.redPeiceBackground, redPeiceBackground = _g === void 0 ? "#feeca0" : _g, _h = _a.blackPeiceBackground, blackPeiceBackground = _h === void 0 ? "#fdec9e" : _h, _j = _a.checkerboardBackground, checkerboardBackground = _j === void 0 ? "#faebd7" : _j;
        /**
         * 当前走棋方
         */
    ...
    Object.defineProperty(ZhChess.prototype, "updateAsync", {
        ...
        configurable: true,
        writable: true,
        value: function (pos, mov, side, moveCb) {
            var _this = this;
            var updateRes = this.update(pos, mov, side);
            if (!updateRes.flag || !mov) {
                return Promise.resolve(updateRes);
            }
            var diffx = (pos.x - mov.x), diffy = (pos.y - mov.y), posX = pos.x, posY = pos.y;
            var xstep = diffx / this.moveSpeed;
            var ystep = diffy / this.moveSpeed;
            ...
            return new Promise(function (resovle) {
                ...
                animateFn();
            }).then(function () { return updateRes; });
        }
    });
    Object.defineProperty(ZhChess.prototype, "update", {
        ...
        value: function (pos, mov, side) {
            ...
            var moveCheck = function (cp) {
                ...
                if (enemyhasTrouble) {
                    var movedPeiceList = _this.livePieceList.filter(function (i) { return !(i.x === posPeice.x && i.y === posPeice.y); });
                    ...
                    var hasMovePoints = _this.checkEnemySideHasMovePoints(enemySide);
                    if (!hasMovePoints) {
                        isOver = true;
                        _this.gameState = "OVER";
                        _this.winner = side;
                ...
                return {
                    ...
                    move: true,
                    cb: function () {
                        var newPeice = chessOfPeiceMap[posPeice.name](__assign(__assign({}, posPeice), mov));
                        if (!isMove) {
                            _this.livePieceList = _this.livePieceList.filter(function (p) { return (!(p.x === cp.eat.x && p.y === cp.eat.y)); });
                        }
                        posPeice.update(mov);
                        _this.moveEvents.forEach(function (f) { return f(newPeice, cp, isOver || enemyhasTrouble, _this.getCurrentPenCode()); });
                        if (isOver) {
    ...
    Object.defineProperty(ZhChess.prototype, "draw", {
        ...
        value: function (ctx) {
            ...
            this.livePieceList.forEach(function (item) {
                ...
                if (item === _this.choosePiece) {
                    item.drawMovePoints(ctx, _this.livePieceList, startX, startY, gridWidth, gridHeight, gridDiffX, gridDiffY, radius);
                }
     ...
     * 画 棋盘 跟 棋子
     */
    Object.defineProperty(ZhChess.prototype, "drawPeice", {
        enumerable: false,
        configurable: true,
        writable: true,
        value: function (pieceList) {
            ...
            this.ctx.clearRect(0, 0, this.width, this.height);
            this.drawChessLine(this.ctx);
            pieceList.forEach(function (p) { return _this.drawSinglePeice(_this.ctx, p, true); });
        }
    });
    /**
     * 绘画单个象棋
     * @param piece 单个象棋
     */
    Object.defineProperty(ZhChess.prototype, "drawSinglePeice", {
        enumerable: false,
        configurable: true,
        writable: true,
        value: function (ctx, piece, replaceXY) {
            var _a = this, startX = _a.startX, startY = _a.startY, gridWidth = _a.gridWidth, gridHeight = _a.gridHeight, gridDiffX = _a.gridDiffX, gridDiffY = _a.gridDiffY, radius = _a.radius;
            var bgfillStyle = piece.side === "BLACK" ? this.blackPeiceBackground : this.redPeiceBackground;
     ...
     * 画出选中的棋子可以移动的点位
     */
    Object.defineProperty(ZhChess.prototype, "drawChoosePieceMovePoint", {
        enumerable: false,
        configurable: true,
        writable: true,
        value: function () {
            var _this = this;
            if (this.choosePiece) {
                var _a = this, gridWidth_1 = _a.gridWidth, startX_1 = _a.startX, startY_1 = _a.startY, gridHeight_1 = _a.gridHeight;
                this.ctx.fillStyle = "#25dd2a";
                this.choosePiece.getMovePoints(this.livePieceList).forEach(function (p) {
                    var x = startX_1 + Math.abs(p.x - _this.gridDiffX) * gridWidth_1;
                    var y = startY_1 + Math.abs(p.y - _this.gridDiffY) * gridHeight_1;
                    _this.ctx.beginPath();
                    _this.ctx.arc(x, y, _this.radius * .25, 0, 2 * Math.PI);
                    _this.ctx.closePath();
                    _this.ctx.fill();
                });
            }
     ...
     * 重新绘画当前棋盘
     */
    Object.defineProperty(ZhChess.prototype, "redraw", {
        enumerable: false,
        configurable: true,
        writable: true,
        value: function () {
     ...
     */
    Object.defineProperty(ZhChess.prototype, "activeMove", {
        enumerable: false,
        configurable: true,
        writable: true,
            ...
            if (typeof this.animate === "function" && typeof this.cancelAnimate === "function") {
                return new Promise(function (resolve) {
                    ...
                    var cb = function () {
                        ...
                        _this.drawSinglePeice(_this.ctx, peice);
                        activePoint.x -= xstep;
                        activePoint.y -= ystep;
                        raf = _this.animate.call(globalThis, cb);
                    };
                    cb();
                });
            }
     ...
     */
    Object.defineProperty(ZhChess.prototype, "moveToPeice", {
        enumerable: false,
        configurable: true,
        writable: true,
     ...
     */
    Object.defineProperty(ZhChess.prototype, "movePeiceToPointAsync", {
        enumerable: false,
        configurable: true,
        writable: true,
    ...
    * @param checkPoint 移动点或者是吃
    */
    Object.defineProperty(ZhChess.prototype, "moveToPeiceAsync", {
        enumerable: false,
        configurable: true,
        writable: true,
        value: function (checkPoint) {
     ...
     * @param side 当前下棋方
     */
    Object.defineProperty(ZhChess.prototype, "moveStart", {
        enumerable: false,
        configurable: true,
        writable: true,
        value: function (mp, checkPoint, drawList, side) {
            ...
            this.moveEnd(p);
            var isOver = false;
            var enemyhasTrouble = this.checkGeneralInTrouble(enemySide, mp, checkPoint, drawList);
            if (enemyhasTrouble) {
                ...
                var hasMovePoints = this.checkEnemySideHasMovePoints(enemySide);
                if (!hasMovePoints) {
                    isOver = true;
                    this.gameState = "OVER";
                    this.winner = side;
            ...
            this.moveEvents.forEach(function (f) { return f(mp, checkPoint, isOver || enemyhasTrouble, _this.getCurrentPenCode()); });
            if (isOver) {
    ...
    Object.defineProperty(ZhChess.prototype, "moveStartAsync", {
        enumerable: false,
        configurable: true,
        writable: true,
        value: function (mp, checkPoint, drawList, side) {
            ...
            return this.movePeiceToPointAsync(p, drawList).then(function () {
                ...
                _this.moveEvents.forEach(function (f) { return f(mp, checkPoint, isOver || enemyhasTrouble, _this.getCurrentPenCode()); });
                if (isOver) {
                    _this.overEvents.forEach(function (f) { return f(side); });
                }
                return null;
     ...
     * @param p 移动点
     */
    Object.defineProperty(ZhChess.prototype, "moveEnd", {
        enumerable: false,
        configurable: true,
        writable: true,
        value: function (p) {
     ...
     */
    Object.defineProperty(ZhChess.prototype, "pieceMove", {
        enumerable: false,
        configurable: true,
        writable: true,
    ...
    */
    Object.defineProperty(ZhChess.prototype, "pieceMoveAsync", {
        enumerable: false,
        configurable: true,
        writable: true,
        value: function (p) {
     ...
     * @param side 下棋方
     */
    Object.defineProperty(ZhChess.prototype, "move", {
        enumerable: false,
        configurable: true,
        writable: true,
        value: function (piecePoint, movePoint, side) {
            ...
            var posPeice = findPiece(this.livePieceList, piecePoint);
     ...
     * @param side 下棋方
     */
    Object.defineProperty(ZhChess.prototype, "moveAsync", {
        enumerable: false,
        configurable: true,
        writable: true,
        value: function (piecePoint, movePoint, side) {
    ...
    */
    ...
    Object.defineProperty(ZhChess.prototype, "checkEnemySideHasMovePoints", {
        ...
        configurable: true,
        writable: true,
        value: function (enemySide) {
            var _this = this;
            // 当前棋子列表
            var currentList = this.currentLivePieceList;
            // 敌方棋子列表
    ...
    */
    Object.defineProperty(ZhChess.prototype, "listenClickAsync", {
        ...
        value: function (e) {
            ...
            var side = this.currentSide;
            this.updateAsync(pos, mov, side, function () {
...
export { CannonPiece, ElephantPiece, GeneralPiece, HorsePiece, KnightPiece, MovePoint, Piece, Point, RookPiece, SoldierPiece, chessOfPeiceMap, ZhChess as default, gen_PEN_Point_Str, gen_PEN_Str, parse_PEN_Str, peiceSideMap };
